...
/* Данный скрипт удаляет товар из стурктуры данныйх корзины,
 * хранящейся в сессии.
 * Отдаёт массив обязательно содержащий количество оставшихся
 * товаров в корзине или ошибку есто таковая всплывёт.
 */
...
// Сериализуем данные корзины и отправляем на клиента
