...
$APPLICATION->SetTitle("Щебень от производителя");
?>
...
<?/* Вставка компонента для вывода списка производств на странице Производство щебня
   * local/templates/.default/components/bitrix/news.list/production-stone/template.php
   */
$APPLICATION->IncludeComponent("bitrix:news.list", "production-stone", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		...
		"COMPONENT_TEMPLATE" => "production-concrete"
	),
	false
);?>
