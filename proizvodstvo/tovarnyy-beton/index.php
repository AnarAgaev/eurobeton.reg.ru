...
$APPLICATION->SetTitle("Товарный бетон от производителя");
?>
...
<?/* Вставка компонента для вывода списка производств на странице Производство бетона
   * local/templates/.default/components/bitrix/news.list/production-concrete/template.php
   */
$APPLICATION->IncludeComponent("bitrix:news.list", "production-concrete", Array(
