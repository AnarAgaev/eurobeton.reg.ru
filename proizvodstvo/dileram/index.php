...
<?$APPLICATION->SetTitle("Сотрудничество с АО «Евробетон» для бизнеса");?>
...
<div class="page-title">
    ...
    <div class="dealers__subtitle">
        <div class="container">
            <div class="row">
                <div class="col-xl-7">
                    <?/* Вклчаемая область Текст страницы под заголовком */
                    ...
                    <div class="dealers__btn-wrap d-flex flex-column align-items-center flex-md-row">
                        ...
                        <div class="dealers__btn-caption">
                            <?/* Вклчаемая область Текст справа от кнопки Оставить заявку */
                            $APPLICATION->IncludeComponent(
                                "bitrix:main.include",
                                "",
                                Array(
                ...
                <div class="col-xl-5">
                    <div class="dealers__subtitle-pic">
                        <?/* Вклчаемая область Картинка в контенте */
                        $APPLICATION->IncludeComponent(
                            "bitrix:main.include",
                            "",
                            Array(
                                ...
                                "AREA_FILE_SUFFIX" => "inc",
                                "EDIT_TEMPLATE" => "",
                                "PATH" => "/include/dealers-img.php"
                            )
                        );?>
                        <div class="dealers__subtitle-caption">
                            <?/* Вклчаемая область Текст под картинкой в контенте страницы */
                            $APPLICATION->IncludeComponent(
                                "bitrix:main.include",
                                "",
                                Array(
                                    ...
                                    "AREA_FILE_SUFFIX" => "inc",
                                    "EDIT_TEMPLATE" => "",
                                    "PATH" => "/include/dealers-img-caption.php"
                                )
                            );?>
                        </div>
                    </div>
