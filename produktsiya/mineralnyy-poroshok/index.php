...
$APPLICATION->SetTitle("Минеральный порошок");
?>
...
<div class="interesting-product section_container">
    <div class="container">
        <div class="interesting-product__title section_title">ВАС ТАКЖЕ МОЖЕТ ЗАИНТЕРЕСОВАТЬ</div>
    </div>
    <div class="container">
        <div class="interesting-product__body d-flex flex-column align-items-center flex-lg-row">
            <div class="interesting-product__pic"><img src="<?=DEFAULT_TEMPLATE_PATH?>/img/mineral.jpg" alt="" title=""></div>
            <div class="interesting-product__content">
                <div class="interesting-product__caption">Известняковая мука</div>
                <div class="interesting-product__txt d-flex justify-content-center justify-content-lg-start">
                    <ul class="list">
                        <li>
                            <div class="interesting-product__txt-title">Применяется:</div>
                        </li>
                        <li class="list-item">При производстве комбикормов</li>
                        <li class="list-item">В качестве раскислителя почв</li>
                    </ul>
                </div>
                <div class="interesting-product__btn d-flex justify-content-center justify-content-lg-start"><a
                            class="btn" href="/produktsiya/izvestnyakovaya-muka/">ПОДРОБНЕЕ</a></div>
            </div>
        </div>
    </div>
</div>
